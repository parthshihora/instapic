...
<!--  
 <form class="form-inline my-2 my-lg-0">
  <a class="btn btn-outline-success my-2 my-sm-0 link " href="/friendprofile">Friends Profile</a>
			...
			<form  action="/friendpost" method="post">
				...
				<div class="col-sm-8">
					<div class="card-body">
						...
						<input type="text" name="comment" class="form-control" size="50" placeholder="Leave Comment">
